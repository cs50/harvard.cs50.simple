define(function(require, exports, module) {
    ...
    function main(options, imports, register) {
        ...
        function load() {
            ...
            // Divs to encapsulate CS50 Submit button
            var div = new ui.divider();
            var div2 = new ui.divider();

            // Insert CS50 Submit button in proper location in ui
            menus.addItemByPath("File/Div", div, 1250, plugin);
            menus.addItemByPath("File/CS50 Submit", cs50SubmitButton, 1260, plugin);
            menus.addItemByPath("File/Div2", div2, 1270, plugin);
